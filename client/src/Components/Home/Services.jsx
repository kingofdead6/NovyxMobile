...
const SERVICES = [
  {
    ...
    desc: "Get instant cash for your old phone. We offer fair prices and fast payment — no hassle.",
    to: "/sell",
    gradient: ["#8B5CF6", "#6C2BD9"],
    glow: "rgba(108,43,217,.7)",
    tag: "SELL",
  },
  {
    icon: "📞",
  ...
  },
  {
    ...
    desc: "Broken screen, dead battery, or water damage — our certified technicians fix it all.",
    to: "/repair",
  ...
  return (
    <section style={{ maxWidth: 1280, margin: "0 auto", padding: "60px 26px 70px" }}>
      <div style={{ marginBottom: 36 }}>
        <p style={{ fontFamily: "'JetBrains Mono'", fontSize: 12.5, letterSpacing: ".12em", color: "#22D3EE", margin: "0 0 12px" }}>
          // OUR SERVICES
        </p>
        ...
        {SERVICES.map(({ icon, label, desc, to, gradient, glow, tag, highlight }) => (
          <div
            ...
            style={{
              ...
              borderRadius: 24,
              cursor: "pointer",
              border: `1px solid ${highlight ? "rgba(34,211,238,.25)" : "rgba(255,255,255,.08)"}`,
              background: highlight
                ? "linear-gradient(165deg,rgba(34,211,238,.07),rgba(8,145,178,.04))"
            ...
            onMouseEnter={e => {
              ...
              e.currentTarget.style.borderColor = highlight ? "rgba(34,211,238,.5)" : "rgba(255,255,255,.18)";
              e.currentTarget.style.boxShadow = `0 24px 50px -16px ${glow}`;
            }}
            onMouseLeave={e => {
              e.currentTarget.style.transform = "translateY(0)";
              e.currentTarget.style.borderColor = highlight ? "rgba(34,211,238,.25)" : "rgba(255,255,255,.08)";

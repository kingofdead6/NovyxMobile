  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 lg:px-12 text-center">
      <motion.div
        ...
        style={{ fontSize: "clamp(96px,18vw,192px)", fontWeight: 300, letterSpacing: "-.04em", color: "rgba(139,92,246,.35)", lineHeight: 1, marginBottom: 24 }}
      >
        404
      </motion.div>
      ...
      >
        <Link
          to="/products"
          style={{ display: "inline-flex", alignItems: "center", padding: "16px 32px", background: "linear-gradient(135deg,#8B5CF6,#6C2BD9)", color: "#fff", fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: 17, borderRadius: 15, textDecoration: "none", boxShadow: "0 20px 46px -14px rgba(108,43,217,.9)" }}
        >
          Back to Shop
        </Link>
      </motion.div>

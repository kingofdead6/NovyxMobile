  ...
  return (
    <section style={{ maxWidth: 1280, margin: "0 auto", padding: "64px 26px 30px" }}>
      <div style={{ textAlign: "center", marginBottom: 42 }}>
        <p style={{ fontFamily: "'JetBrains Mono'", fontSize: 12.5, letterSpacing: ".12em", color: "#22D3EE", margin: "0 0 10px" }}>// WHY NOVYX</p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(230px,1fr))", gap: 18 }}>
        {FEATURES.map((f, i) => (
          <div
            ...
            onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-6px)"; e.currentTarget.style.borderColor = "rgba(139,92,246,.45)"; }}
            onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.borderColor = "rgba(255,255,255,.08)"; }}
          >
            <div style={{ width: 54, height: 54, borderRadius: 15, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, background: "linear-gradient(135deg,rgba(139,92,246,.25),rgba(34,211,238,.15))", border: "1px solid rgba(139,92,246,.3)", marginBottom: 18 }}>{f.icon}</div>

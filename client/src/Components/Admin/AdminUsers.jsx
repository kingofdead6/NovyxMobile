        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 14, marginBottom: 36 }}>
            <button
              ...
              style={{ display: "flex", alignItems: "center", gap: 10, padding: "13px 22px", background: "linear-gradient(135deg,#8B5CF6,#6C2BD9)", color: "#fff", fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: 15, border: "none", borderRadius: 14, cursor: "pointer" }}
            >
              ...
              {filteredUsers.map(user => (
                ...
                >
                  <div style={{ padding: 24, textAlign: "center" }}>
                    ...
                    <span style={{ display: "inline-block", padding: "4px 16px", borderRadius: 999, fontSize: 12, fontWeight: 700, fontFamily: "'JetBrains Mono'", background: user.usertype === "superadmin" ? "rgba(139,92,246,.2)" : "rgba(59,130,246,.2)", color: user.usertype === "superadmin" ? "#c4b5fd" : "#93c5fd", border: `1px solid ${user.usertype === "superadmin" ? "rgba(139,92,246,.4)" : "rgba(59,130,246,.4)"}` }}>
...
const btnPrimary = { flex: 1, padding: "14px", background: "linear-gradient(135deg,#8B5CF6,#6C2BD9)", color: "#fff", fontFamily: "'Space Grotesk'", fontWeight: 700, fontSize: 15, border: "none", borderRadius: 14, cursor: "pointer" };

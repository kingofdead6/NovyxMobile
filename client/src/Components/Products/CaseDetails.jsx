      ...
      <div style={{ display: "flex", gap: 46, alignItems: "flex-start", flexWrap: "wrap" }}>
        ...
        <div style={{ flex: 1, minWidth: 300, position: "sticky", top: 96, animation: "fadeUp .6s both" }}>
          ...
          >
            ...
            {images.length > 0 ? (
              ...
              <div style={{ position: "relative", zIndex: 2, width: 160, height: 300, borderRadius: 28, background: "linear-gradient(165deg,#8B5CF6,#6C2BD9)", transform: "translateZ(50px)" }} />
            )}
          </div>
        ...
        <div style={{ flex: 1, minWidth: 300, animation: "fadeUp .6s both .08s" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
            ...
            {item.color && (
              <span style={{ fontFamily: "'JetBrains Mono'", fontSize: 12, padding: "5px 11px", borderRadius: 8, background: "rgba(255,255,255,.07)", border: "1px solid rgba(255,255,255,.12)", color: "#cbd5e1" }}>
                {item.color}
              </span>
            )}
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                {item.compatibleModels.map((model, i) => (
                  <span key={i} style={{ fontFamily: "'JetBrains Mono'", fontSize: 11.5, padding: "4px 10px", borderRadius: 8, background: "rgba(139,92,246,.1)", border: "1px solid rgba(139,92,246,.25)", color: "#c4b5fd" }}>
                    {model}
                  </span>
                ))}
              </div>
      ...
      {related.length > 0 && (
        <section style={{ marginTop: 64 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(220px,1fr))", gap: 18 }}>
            {related.map(c => (
              <RelatedCard key={c._id} item={c} onClick={() => navigate(`/case/${c._id}`)} />
            ))}
          </div>
        </section>
      )}
